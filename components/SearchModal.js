  ...
  const modalContent = (
    <AnimatePresence>
      {props.showModal ? (
        ...
        >
          <div className=' fixed top-1/2 left-0 z-30 mx-auto w-[calc(100%-48px)] -translate-y-1/2 translate-x-6 rounded-lg bg-white dark:bg-verydarkblue sm:w-[calc(100%-80px)] sm:translate-x-10 md:hidden'>
